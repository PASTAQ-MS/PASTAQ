...
//     // Initialize matrix for values and counts
...
//     // Create vectors to return (flattened values)
//     // std::vector<double> x_edges, y_edges, z_values;
...
//     // Flatten the value_matrix and store x, y, and z values
//     // for (int i = 0; i < x_bins; ++i) {
//     //     for (int j = 0; j < y_bins; ++j) {
//     //         if (count_matrix[i][j] > 0) {
//     //             double z_value = std::log1p(value_matrix[i][j] / count_matrix[i][j]);
//     //             x_values.push_back(x_edges[i]);
//     //             y_values.push_back(y_edges[j]);
//     //             z_values.push_back(z_value);
//     //         }
//     //     }
//     // }

//     // Return the results as three vectors
//     return {x_edges, y_egdes, value_matrix};
// }
...
HeatmapData TimsVisualization::heatmap_data(int x_bins, int y_bins) {
    ...
    return {x_edges, y_edges, value_matrix};
}
