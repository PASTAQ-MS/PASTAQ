...
TEST_CASE("DEBUG") {
    std::vector<Centroid::Peak> peaks = {
        ...
        TestUtils::mock_gaussian_peak(7, 300.0, 402.0, 2000.0, 0.001, 10),
        TestUtils::mock_gaussian_peak(8, 100.0, 402.0, 2000.0, 0.001, 10),
        TestUtils::mock_gaussian_peak(9, 45.0, 402.5, 2000.0, 0.001, 10),
        TestUtils::mock_gaussian_peak(10, 12.0, 403.0, 2000.0, 0.001, 10),
        TestUtils::mock_gaussian_peak(11, 2.0, 403.5, 2000.0, 0.001, 10),
        TestUtils::mock_gaussian_peak(12, 30000.0, 402.0, 2000.0, 0.001, 10),
        TestUtils::mock_gaussian_peak(13, 30000.0, 402.5, 2000.0, 0.001, 10),
    };
